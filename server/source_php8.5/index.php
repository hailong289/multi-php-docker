...
$translations = [
    'en' => [
        ...
        'service.postgres' => 'PostgreSQL database with persistent storage for local applications.',
    ...
    'vi' => [
        ...
        'service.postgres' => 'Cơ sở dữ liệu PostgreSQL có lưu trữ bền vững cho ứng dụng local.',
