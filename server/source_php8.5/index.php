...
$translations = [
    'en' => [
        ...
        'service.postgres' => 'PostgreSQL with durable storage for apps that prefer it over MySQL.',
    ...
    'vi' => [
        ...
        'service.postgres' => 'PostgreSQL có lưu trữ bền vững cho ứng dụng dùng Postgres thay vì MySQL.',
...
$services = [
    ...
    ['code' => 'PG', 'name' => 'PostgreSQL', 'meta' => '5432', 'text' => 'service.postgres'],
