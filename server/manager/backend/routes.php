...
return [
    ...
    ['GET', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq|kafka)/compose', [InfraController::class, 'composeShow']],
    ['PUT', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq|kafka)/compose', [InfraController::class, 'composeSave']],
    ['GET', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq|kafka)/logs', [InfraController::class, 'logs']],
    ['GET', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq|kafka)/action-logs', [InfraController::class, 'actionLogs']],
    ['POST', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq|kafka)/(?P<action>start|stop|restart|create|pull-recreate|delete|delete-image)', [InfraController::class, 'action']],
