...
return [
    ...
    ['POST', '/infra-services/compose-files/(?P<name>[a-zA-Z0-9][a-zA-Z0-9._-]{0,120}\\.(?:yml|yaml))/(?P<action>create|start)', [InfraController::class, 'composeFileAction']],
    ...
    ['GET', '/infra-services/(?P<service>mysql|redis|rabbitmq)/action-logs', [InfraController::class, 'actionLogs']],
    ['POST', '/infra-services/(?P<service>mysql|redis|rabbitmq)/(?P<action>start|stop|restart|create|pull-recreate|delete|delete-image)', [InfraController::class, 'action']],
