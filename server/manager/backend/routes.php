...
return [
    ...
    ['GET', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq)/compose', [InfraController::class, 'composeShow']],
    ['PUT', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq)/compose', [InfraController::class, 'composeSave']],
    ['GET', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq)/logs', [InfraController::class, 'logs']],
    ['GET', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq)/action-logs', [InfraController::class, 'actionLogs']],
    ['POST', '/infra-services/(?P<service>mysql|postgres|redis|rabbitmq)/(?P<action>start|stop|restart|create|pull-recreate|delete|delete-image)', [InfraController::class, 'action']],
