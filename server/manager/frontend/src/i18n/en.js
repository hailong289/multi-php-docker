export const en = {
  ...
  'domains.subtitle': 'List domains, refresh status from the OS hosts file, or write hosts with admin help.',
  ...
  'domains.sync_button': 'Sync domains from hosts file',
  ...
  'hosts.status_refreshed': 'Domain status updated from the hosts file.',
  'hosts.read_unavailable': 'Cannot read the mounted hosts file. Check docker-compose HOSTS_FILE / MANAGER_HOSTS_PATH.',
  'hosts.sync_failed': 'Hosts sync failed.',
  'hosts.controller_unavailable': 'Hosts status is not available yet.',
  ...
  'hosts.progress_protocol': 'Opening Windows hosts writer (approve UAC if shown)…',
  ...
  'hosts.domain_added': 'Domain saved. Writing hosts via the Windows protocol…',
  'hosts.domain_updated': 'Domain updated. Writing hosts via the Windows protocol…',
  'hosts.domain_removed': 'Domain removed. Writing hosts via the Windows protocol…',
  'hosts.watch_required': 'Hosts were not written. On Windows run: powershell -ExecutionPolicy Bypass -File .\\scripts\\ensure_hosts_env.ps1 then retry Write hosts.',
  'hosts.protocol_required': 'Register the Windows protocol once, then retry: powershell -ExecutionPolicy Bypass -File .\\scripts\\ensure_hosts_env.ps1',
  'hosts.protocol_pending': 'Waiting for the hosts writer. Approve the browser/UAC prompt if shown, or re-run ensure_hosts_env.ps1.',
  'hosts.controller_hint': 'Sync reads the hosts file only. To write hosts on Windows, register once: powershell -ExecutionPolicy Bypass -File .\\scripts\\ensure_hosts_env.ps1 — then use Write hosts (Admin).',
  'hosts.sync_hint': 'Compares Manager domains against the OS hosts file and updates status badges.',
