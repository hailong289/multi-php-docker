export const en = {
  ...
  'hosts.controller_hint': 'Sync reads the hosts file only. To write hosts, run ./scripts/ensure_hosts_env.sh (macOS) or ensure_hosts_env.ps1 (Windows), then use Write hosts (Admin).',
