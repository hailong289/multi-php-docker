export const vi = {
  ...
  'hosts.controller_hint': 'Đồng bộ chỉ đọc file hosts. Để ghi hosts: chạy ./scripts/ensure_hosts_env.sh (macOS) hoặc ensure_hosts_env.ps1 (Windows), rồi dùng Ghi hosts (Admin).',
